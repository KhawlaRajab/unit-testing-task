...
describe('Calculator', () => {
  ...
  it('should throw an error for invalid input types', () => {
    ...
    // Test case: number larger than 1000
    it("ignore numbers larger than 1000", () => {
      expect(calc(1001, '+', 2)).toBe(2);
    });
  
    it("ignore numbers larger than 1000", () => {
      expect(calc(10000, '+', 2000, '-', 1020, '+', 8)).toBe(8);
    });
    ...
    it("ignore numbers larger than 1000", () => {
     ...
     // Test case: more than 2 numbers
    it('should handle more than 2 numbers', () => {
      expect(calc(1, '+', 2 , '*', 3 , '/' , 6)).toBe(2);
    });
